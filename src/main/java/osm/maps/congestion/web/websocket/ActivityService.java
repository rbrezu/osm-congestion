package osm.maps.congestion.web.websocket;
...
import osm.maps.congestion.web.websocket.dto.ActivityDTO;
...
import static osm.maps.congestion.config.WebsocketConfiguration.IP_ADDRESS;
